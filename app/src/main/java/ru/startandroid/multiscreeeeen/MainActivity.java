package ru.startandroid.multiscreeeeen;
...
public class MainActivity extends ListActivity {
    ...
    String[] things = { "Рубик", "Иллюзия", "Часы", "Картина"};
    @Override
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                switch (position) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        Intent intent3 = new Intent(MainActivity.this, clock.class);
                        startActivity(intent3);
                        break;

                    case 3:
                        Intent intent4 = new Intent(MainActivity.this, kartinka.class);
